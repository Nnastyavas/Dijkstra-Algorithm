...
#include"../laba3/DAlgorithm.h"
#include <fstream>
#include"../laba3/input_data_function.h"
...
namespace UnitTestDijkstra
{
	...
	public:
		...
		{
			ifstream vvod("C:\\Users\\User\\Desktop\\laba3\\laba3\\input.txt");
			...
			Assert::AreEqual(adj->DAlgorithm(city_Start, city_End), cur);
		}
